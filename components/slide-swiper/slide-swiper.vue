<template>
	<view class="goodsSwiperBox" v-show="detail">
		<swiper class="gswSw" v-if="detail.list&&detail.list.length>0" :display-multiple-items="config.multiple||3" :autoplay="config.autoplay" @change="swiperChange" :disable-touch="disable">
...
<style>
	.goodsSwiperBox{width: 710rpx;margin: 20rpx 0 20rpx 20rpx;border-radius: 20rpx;background: #fff;position: relative;box-sizing: border-box;}
	...
	.gswSw{height: 230rpx;}
	.gswGoods{width: 100%;padding-left: 10rpx;}
	.gswGoods image{width: 100%;height: 176rpx;border-radius: 10rpx;display: block;}
	.gswGoods .goodsTxt{text-overflow: ellipsis;overflow: hidden;font-size:25upx;margin-top:10upx;white-space: nowrap;color:#8e8e8e;line-height: 33rpx;text-align: left;}
	.gswGoods .goodsPrice{text-overflow: ellipsis;overflow: hidden;white-space: nowrap;color: #FF3636;font-size: 30rpx;line-height: 42rpx;display: flex;justify-content: center;}
